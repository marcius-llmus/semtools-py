...
class TestDocumentLoader:
    def test_load_from_files(self, mock_file):
        
        mock_model = MagicMock()
        loader = DocumentLoader(model=mock_model)

        documents = loader.load([str(mock_file)])
    ...
    def test_load_from_stdin(self, mocker):
    ...
    def test_load_non_existent_file(self, ):
        ...
        documents = loader.load(["/non/existent/file.txt"])
    ...
    def test_load_empty_file(self, tmp_path):
        ...
        documents = loader.load([str(empty_file)])

        
        assert not documents

    def test_create_document_from_lines(self, ):
        
        mock_model = MagicMock()
        loader = DocumentLoader(model=mock_model)

        
        doc = loader._create_document_from_lines("path", ["line 1"])
